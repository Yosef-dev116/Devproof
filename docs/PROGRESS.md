...
- Not yet done: actually provisioning the Render/Vercel projects and the second OAuth App (needs the user's own account access), and a live end-to-end verification against the real deployed stack.
